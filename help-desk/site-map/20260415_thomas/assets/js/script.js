...
var SCENES = {
  ...
  frontofschool: {
    ...
    dialogue: "",
    exits: [
      { label: "Enter the school", to: "hallway" },
    ],
  },
  ...
  hallway: {
    ...
    exits: function () {
      ...
      if (state.tookCandy) {
        options.push({ label: "Go back upstairs to classroom 1", to: "classroom1_after" });
      }
  ...
  classroom1: {
    ...
    dialogue: "Teacher: Hi Thomas, welcome to class! For everyone's good work, I am giving out candy!",
    exits: [
      { label: "Take the candy bar", to: "took_candy" },
    ],
  },
  ...
  took_candy: {
    ...
    exits: [
      { label: "Eat the candy bar", to: "allergy_reaction" },
    ],
  },
  ...
  allergy_reaction: {
    ...
    dialogue: "Teacher: Oh my goodness, are you allergic to peanuts? You need to get the epipen!",
    onEnter: function () {
    ...
    exits: [
      { label: "Go to the hallway to find the epipen", to: "hallway" },
    ],
  },
  ...
  classroom204: {
    ...
    dialogue: function () {
      if (timesVisited("classroom204") <= 1) return "Teacher: Hi Thomas, are you okay?";
    ...
    exits: function () {
      if (timesVisited("classroom204") <= 1) {
        return [
          { label: "No, I need the epipen. Have you seen it?", to: "classroom204_response" },
          { label: "Go back to the hallway", to: "hallway" },
        ];
      }
      return [
  ...
  classroom204_response: {
    ...
    dialogue: "Teacher: I think I saw it in the cafeteria. I am not too sure. Look around!",
    exits: [
      { label: "Go to the hallway", to: "hallway" },
    ],
  },
  ...
  classroom208: {
    ...
    exits: function () {
      if (timesVisited("classroom208") <= 1) {
        return [
          { label: "Yes, do you know where the epipen is?", to: "classroom208_response" },
          { label: "Go back to the hallway", to: "hallway" },
        ];
      }
      return [
  ...
  classroom208_response: {
    ...
    dialogue: "Teacher: No, but I have heard it is somewhere in the cafeteria or downstairs.",
    exits: [
  ...
  classroom208_followup: {
    ...
    character: "teacher4",
    text: "You are in classroom 208.",
    dialogue: "Teacher: Perhaps try the janitor's office, they keep track of everything in this school.",
    onEnter: function () {
  ...
  annoying_kid: {
    ...
    dialogue: "Kid: Hey Thomas what's up, you want to play right now? It's recess!",
    exits: [
  ...
  kid_play: {
    ...
    exits: [
      { label: "Okay, I'll meet you there!", to: "kid_escape" },
    ],
  },
  ...
  cafeteria_callout2: {
    ...
    exits: [
      { label: "Leave the cafeteria", to: "downstairs" },
    ],
  },
  ...
  janitor_office: {
    ...
    exits: [
      { label: "I'm having an allergic reaction! I need the epipen!", to: "janitor_response" },
      { label: "Go back downstairs", to: "downstairs" },
    ],
  },
  ...
  win: {
    ...
    dialogue: "Janitor: There you go, kid. You're going to be okay. Let's get you to the nurse.",
    exits: [
      { label: "Play again", to: "restart" },
    ],
  },
  ...
  game_over: {
    ...
    dialogue: "A teacher finds you and calls 911. You are rushed to the hospital.",
    exits: [
      { label: "Try again", to: "restart" },
    ],
  },
};
...
function renderScene(sceneId) {
  ...
  document.getElementById("dialogue").textContent = getValue(scene.dialogue) || "";
